...
! function (a) {
  ...
  return c.prototype.update = function () {
    ...
    return "fast" === a ? 1.5 : "slow" === a ? .33 : "none" === a ? 0 : .66
...
var canvasDiv = document.getElementById('particle-canvas-new');
var options = {
  particleColor: '#767676',
...
var options = {
  particleColor: '#888',
  background: '/images/about_bg.jpg',
  interactive: true,
  speed: 'fast',
  density: 'high',
};
var particleCanvas = new ParticleNetwork(canvasDiv, options);
var canvasDiv = document.getElementById('particle-canvas-mission');
var options = {
  particleColor: '#888',
  background: '/images/about_bg.jpg',
  interactive: true,
...
var particleCanvas = new ParticleNetwork(canvasDiv, options);
var canvasDiv = document.getElementById('particle-canvas-value');
var options = {
  particleColor: '#767676',
  background: '/images/vision.jpg',
  interactive: true,
